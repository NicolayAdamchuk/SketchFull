...
{   
   ...
   public class Vector4
   {
      ...
      /// Точка XYZ
      /// </summary>
      public XYZ ConvertXYZ()
      {
          return new XYZ(X, Y, Z);
      }
      /// <summary>
      /// Привести к рабочей плоскости
      /// </summary>
      public void ToWorkPlane(Plane work_plane)
      {
          if (work_plane == Plane.XY)
          {
              m_z = 0; return;
          }
          if (work_plane == Plane.XZ)
          {
              m_y=0;   return;
          }
          if (work_plane == Plane.YZ)
          {
              m_z=0; return;
          }
   ...
   public class Matrix4
   {
      ...
      public static Matrix4 Multiply(Matrix4 left, Matrix4 right)
      {
        ...
        ///// <summary>
        ///// Преобразовать кривую
        ///// </summary>
        ///// <param name="point">point to be transformed</param>
        ///// <returns>transform result</returns>
        
        //public Curve TransformCurve(Curve curve)
        //{
        //    Line line = curve as Line;
        //    Arc arc = curve as Arc;
        //    if(line!=null)
        //    {                
        //        Vector4 p0 = Transform(new Vector4(line.GetEndPoint(0)));
        //        Vector4 p1 = Transform(new Vector4(line.GetEndPoint(1)));
        //        XYZ start = p0.ConvertXYZ();
        //        XYZ end = p1.ConvertXYZ();
        //        return Line.CreateBound(start, end) as Curve;
        //    }
        //    if(arc!=null)
        //    {
        //        Vector4 p0 = Transform(new Vector4(arc.GetEndPoint(0)));
        //        Vector4 p1 = Transform(new Vector4(arc.GetEndPoint(1)));
        //        Vector4 p3 = Transform(new Vector4(arc.Center));
        //        XYZ start = p0.ConvertXYZ();
        //        XYZ end = p1.ConvertXYZ();
        //        XYZ middle= p3.ConvertXYZ();
        //        Arc arc_new = Arc.Create(start,end,middle);
        //        return arc_new as Curve;
        //    }
        //    return null;
        //}
